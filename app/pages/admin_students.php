...
<body class="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans text-slate-800 dark:text-slate-200 transition-colors duration-200">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="p-6 md:p-8 max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Manage Students</h1>
                        <p class="text-slate-500 dark:text-slate-400 mt-2">Add, edit, or remove student accounts.</p>
                    </div>
    ...
    <!-- Add Student Modal -->
    <dialog id="addStudentModal" onclick="if(event.target === this) this.close()" class="p-0 rounded-xl shadow-2xl backdrop:bg-black/50 dark:bg-slate-800 dark:text-white w-full max-w-md">
    ...
    <dialog id="deleteStudentModal" onclick="if(event.target === this) this.close()" class="p-0 rounded-xl shadow-2xl backdrop:bg-black/50 dark:bg-slate-800 dark:text-white w-full max-w-md">
        <div class="p-6">
    ...
    <!-- Edit Student Modal -->
    <dialog id="editStudentModal" onclick="if(event.target === this) this.close()" class="p-0 rounded-xl shadow-2xl backdrop:bg-black/50 dark:bg-slate-800 dark:text-white w-full max-w-md">
