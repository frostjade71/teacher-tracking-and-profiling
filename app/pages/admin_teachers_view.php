<?php
// app/pages/admin_teachers_view.php
...
// Trigger auto-offline check logic
...
<body class="bg-gray-50 dark:bg-slate-900 min-h-screen text-slate-800 dark:text-slate-200 transition-colors duration-200 font-sans">
            ...
            <div class="p-4 md:p-8 max-w-7xl mx-auto font-sans">
                <div class="relative text-left mb-6 md:mb-10 pt-6">
                    ...
                    <h1 class="text-2xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-2 md:mb-3 tracking-tight">
                        Teachers <span id="rotatingText" class="rotating-text text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Directory</span>
                    </h1>
                </div>

                <!-- Search Bar -->
                <div class="max-w-3xl mb-12 relative z-20">
                    <div class="relative flex items-center bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 p-2 transition-transform focus-within:scale-[1.01] duration-300">
                        ...
                        <input type="text" id="teacherSearch" value="<?= htmlspecialchars($search) ?>" 
                            class="w-full px-4 py-3 bg-transparent text-sm md:text-base font-medium text-slate-700 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none"
                ...
                <div id="teacherGrid" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 relative z-10">
                    ...
                    <?php foreach ($teachers as $t): ?>
                        <?php $status = $t['latest_status'] ?? 'UNKNOWN'; ?>
                        <a href="<?= url('?page=student_teacher&id=' . $t['id']) ?>" 
                           ...
                           class="teacher-card group relative flex flex-col bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-400 dark:hover:border-blue-500 hover:-translate-y-1 hover:z-30">
                            ...
                            <div class="relative z-10 flex items-center gap-2 mb-4">
                                <div class="h-10 w-10 flex-shrink-0 rounded-xl bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-300 font-bold text-lg shadow-inner">
                ...
                <div id="noResults" class="hidden max-w-lg mx-auto text-center py-20">
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 p-8">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 text-sm mb-6">We couldn't find any faculty members matching your search.</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Text Rotation Logic
        const rotateWords = ["Directory", "Faculty", "Staff"];
        let rotateIndex = 0;
