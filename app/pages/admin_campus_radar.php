...
<body class="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans text-slate-800 dark:text-slate-200 transition-colors duration-200">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto">
             <!-- Top Bar -->
            <header class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 h-16 flex items-center justify-between px-8 sticky top-0 z-10 transition-colors duration-200">
            ...
            <div class="p-8 max-w-6xl mx-auto">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h1 class="text-3xl font-bold text-slate-900 dark:text-white mb-2">Campus Radar Configuration</h1>
                        <p class="text-slate-500 dark:text-slate-400">Set the main campus location and geofence radius. Teachers outside this zone will be marked "Off Campus".</p>
                    </div>
