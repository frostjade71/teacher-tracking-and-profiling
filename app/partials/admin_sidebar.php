...
<aside class="w-64 bg-slate-900 dark:bg-slate-950 text-white flex-shrink-0 hidden md:flex flex-col border-r border-slate-800 z-20">
    ...
    <nav class="flex-1 px-3 py-6 space-y-1">
        ...
        <a href="/?page=admin_dashboard" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_dashboard') ?>">
        ...
        <a href="/?page=admin_analytics" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_analytics') ?>">
        ...
        <a href="/?page=admin_monitor" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_monitor') ?>">
        ...
        <a href="/?page=admin_campus_radar" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_campus_radar') ?>">
        ...
        <a href="/?page=admin_teachers" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_teachers') ?>">
        ...
        <a href="/?page=admin_students" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_students') ?>">
        ...
        <a href="/?page=admin_admins" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_admins') ?>">
        ...
        <a href="/?page=admin_subjects" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_subjects') ?>">
        ...
        <a href="/?page=admin_audit" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-colors <?= isActive('admin_audit') ?>">
